...
type TakeProductsParams = {
    vendingMachineId: EntityId;

    productIds: EntityId[];
} & CommonRequestParams;

export default class TakeProducts implements UseCase<TakeProductsParams, Product[]> {

    execute(params?: TakeProductsParams | undefined): Product[] | Promise<Product[]> {
